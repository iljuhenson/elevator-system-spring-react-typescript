      ...
      <>
        {elevatorsStatus.map(elevator => {
          ...
          for (let i = 29; i >= 0; ++i) {
            ...
            } else if(elevator.destinationFloors.filter(user => user.pickupFloor === i && !user.isPickedUp)) {
              floors.push(<div
            ...
            } else if(elevator.destinationFloors.filter(user => user.destinationFloor === i && user.isPickedUp)) {
              floors.push(<div
